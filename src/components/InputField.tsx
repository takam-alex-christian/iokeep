    ...
    return (
        <div className='relative overflow-hidden outline outline-1 outline-neutral-300 rounded-2xl focus-within:outline focus-within:outline-1 focus-within:outline-green-300 '>
            <input
                ...
                className={"w-full p-4 text-base font-semibold focus:outline-none" + " " + props.className} />
            {
                typeof (props.type) != "undefined" && props.type == "password" &&

                <div className="absolute h-full flex justify-center items-center z-10 px-2 right-2 top-0 bg-tranparent">

                    <button type={"button"}
                        className="focus:outline-none bg-tansparent"
