...
export default function InputField(props: {
    ...
    return (
        <div className='relative overflow-hidden outline outline-1 outline-neutral-300 rounded-2xl focus-within:outline focus-within:outline-1 focus-within:outline-blue-300 '>
            ...
            <div className="absolute flex h-full justify-center items-center z-10 px-2 right-2 top-0 bg-white">
                <button
                    ...
                    onClick={hideShowButtonHandler}><FontAwesomeIcon icon={isContentVisible ? faEyeSlash : faEye} />
                </button>
            </div>
        </div>
    )
